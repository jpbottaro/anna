...
class SequenceUtilsTest(tf.test.TestCase):
    def test_seq_roll(self):
        ...
        self.assertAllEqual(y, [[0, 0, 1], [1, 0, 1], [0, 0, 1]])
    ...
    def test_seq_roll(self):
        ...
        self.assertAllEqual(small, [[[0]], [[1]], [[0]]])
        self.assertAllEqual(same, x)
        self.assertAllEqual(large, [[[0], [1], [0], [0], [0]],
                                    [[1], [0], [1], [0], [0]],
                                    [[0], [0], [1], [0], [0]]])
    ...
    def test_seq_concat(self):
        ...
        self.assertAllEqual(res, [[[2], [1], [1], [1]],
                                  [[1], [3], [1], [1]],
                                  [[1], [0], [0], [0]]])
        self.assertAllEqual(res_len, [4, 4, 1])
